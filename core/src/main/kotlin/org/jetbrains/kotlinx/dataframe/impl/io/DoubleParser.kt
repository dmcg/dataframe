...
public open class DoubleParser(private val parserOptions: ParserOptions) {
    ...
    protected val numberFormatSymbols: NumberFormatSymbols = run {
    ...
    protected open val parser: ConfigurableDoubleParser = ConfigurableDoubleParser(numberFormatSymbols, true)
